module github.com/BuxOrg/bux-kube-controller

go 1.17

replace github.com/BuxOrg/bux-server => /git/bux-server

require (
	github.com/BuxOrg/bux v0.1.6
	github.com/BuxOrg/bux-server v0.0.0-00010101000000-000000000000
